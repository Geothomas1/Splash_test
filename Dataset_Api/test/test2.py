...
mylist=['com.onegamez.witch.witchdom', 
        'com.onegamez.halloween.witch.puzzle', 
        'com.onegamez.pooch.pop', 
        'com.onegamez.word.championship', 
        'com.onegamez.candy.cookie.burst', 
        'com.onegamez.balloon.burst.paradise', 
        'com.onegamez.garden.craze', 
        'com.candy.cursh.match.game'
    ]
